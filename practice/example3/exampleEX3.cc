...
//
/// \file exampleEX3.cc
/// \brief Main program of the EX3 example
...
int main(int argc,char** argv)
{
  ...
  runManager->SetUserInitialization(new EX3::DetectorConstruction());
  ...
  runManager->SetUserInitialization(new EX3::ActionInitialization());
